...
"""Known failing educational attempt: v0 naive CUDA matmul.

This kernel does not satisfy PMPP_v2's strict FP16 numerical check. Do not
submit it as a correct result. The experiment copy lives at
