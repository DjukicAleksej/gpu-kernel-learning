...
"""v17: isolate a write-through output store on the retained v10 kernel."""
...
__global__ void grayscale_exact_grid_kernel(
    ...
    store_write_through(output + group, grayscale_group(image, group));
}
...
_module = load_inline(
    name="pmpp_grayscale_v17_write_through_store_ext",
